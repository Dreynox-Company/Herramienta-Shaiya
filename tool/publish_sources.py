...
def verified_sources() -> dict[str, bytes]:
    ...
    if manifest.get("base_commit") != BASE or manifest.get("version") != "0.3.0+4":
...
def main() -> None:
    ...
    parser.add_argument("--branch", default="feat/studio-03-integration")
    ...
    run("commit", "-m", "feat: integrate native Shaiya 0.3 assets, worlds, movement and targeting")
