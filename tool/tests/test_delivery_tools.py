...
class DeliveryToolsTest(unittest.TestCase):
    ...
    def test_source_restored_even_when_runner_generation_fails(self):
        with tempfile.TemporaryDirectory() as folder:
            ...
            (root / 'pubspec.yaml').write_text('version: 0.3.0+4')
            ...
            self.assertEqual((root / 'pubspec.yaml').read_text(), 'version: 0.3.0+4')
    ...
    def manifest(self, root):
        ...
        manifest = {'version': '0.3.0+4', 'base_commit': publish_sources.BASE, 'files': files}
