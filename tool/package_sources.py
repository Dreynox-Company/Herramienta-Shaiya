...
def package(destination: Path) -> None:
    ...
    with zipfile.ZipFile(temp, 'w', zipfile.ZIP_DEFLATED, compresslevel=6) as z:
        for name, data in files.items():
            z.writestr('Shaiya_Studio_0_6_0/' + name, data)
        z.writestr('Shaiya_Studio_0_6_0/manifest-entrega.json', manifest)
...
if __name__ == '__main__':
    ...
    p.add_argument('destination', nargs='?', default=str(ROOT / 'dist/Shaiya_Studio_0_6_0_Flutter.zip'))
