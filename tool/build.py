...
def main() -> None:
    ...
    with log_path.open("w", encoding="utf-8") as log:
        ...
        if args.platform in ("windows", "both"):
            ...
            target = dist / "Shaiya_Studio_0_3_1_Windows.zip"
        ...
        if args.platform in ("android", "both"):
            ...
            target = dist / "Shaiya_Studio_0_3_1_Android_PRUEBAS.apk"
            shutil.copy2(apk, target)
            produced.append(str(target))
        report = {"version": "0.3.1+5", "platform": args.platform, "commands": commands,
