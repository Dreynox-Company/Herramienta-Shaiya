...
void main() {
  test('mounted families do not confuse claws, dual weapons or daggers with swords', () {
  ...
  test('mounted composition freezes lower-body, rejects ground root motion and closes its seam', () {
    final parents = [-1, 0, 1, 2, 1];
    final seat = synthetic(parents), attack = synthetic(parents, attack: true);
