...
class PsCharacterHitpoints {
  ...
  static PsCharacterHitpoints parse(PsPacket p){
    ...
    return PsCharacterHitpoints(
      d.getInt32(0,Endian.little),d.getInt32(4,Endian.little),d.getInt32(8,Endian.little),
    );
  }
}
class PsCharacterDetails {
  ...
  static PsCharacterDetails parse(PsPacket p){
    ...
    return PsCharacterDetails(
      strength:d.getUint16(0,Endian.little),dexterity:d.getUint16(2,Endian.little),
      reaction:d.getUint16(4,Endian.little),intelligence:d.getUint16(6,Endian.little),
      wisdom:d.getUint16(8,Endian.little),luck:d.getUint16(10,Endian.little),
      statPoints:d.getUint16(12,Endian.little),skillPoints:d.getUint16(14,Endian.little),
      maxHp:d.getUint32(16,Endian.little),maxMp:d.getUint32(20,Endian.little),
      maxSp:d.getUint32(24,Endian.little),angle:d.getUint16(28,Endian.little),
      previousExp:d.getUint32(30,Endian.little),nextExp:d.getUint32(34,Endian.little),
      currentExp:d.getUint32(38,Endian.little),gold:d.getUint32(42,Endian.little),
      x:d.getFloat32(46,Endian.little),y:d.getFloat32(50,Endian.little),z:d.getFloat32(54,Endian.little),
    );
  }
}
