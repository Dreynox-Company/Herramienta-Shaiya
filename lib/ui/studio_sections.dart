...
class StudioSection extends StatelessWidget {
  ...
  const StudioSection({super.key, required this.title, required this.children,
    this.help, this.initiallyExpanded = true});
  @override
  Widget build(BuildContext context) => Padding(
    padding: const EdgeInsets.only(bottom: 6),
    child: ExpansionTile(key: PageStorageKey('studio-section-$title'),
      initiallyExpanded: initiallyExpanded, maintainState: true,
      ...
      title: Text(title, style: const TextStyle(fontSize: 12,
        fontWeight: FontWeight.w600, color: EditorStyle.text)),
      children: [if (help != null) Padding(padding: const EdgeInsets.only(bottom: 6),
...
class StudioDockContent {
  ...
  static const detailTitles = {
    'Mirada natural', 'Apariencia guardada', 'Mejora y elemento',
    'Ajustes de alas', 'Ajustes de montura', 'Efectos y sonido',
    'Registro', 'Visualización', 'Recursos indexados',
  };
