...
class StudioScene extends ChangeNotifier {
  ...
  ({double x,double y})? projectWorldPoint(
    double worldX,double worldY,double worldZ,double width,double height, {
    double lift=0,
  }){
