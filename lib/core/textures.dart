...
class Pixels {
  ...
  static Pixels dds(Uint8List bytes,String source) {
    ...
    if(d.getUint32(0,Endian.little)!=0x20534444||d.getUint32(4,Endian.little)!=124)r.fail('Cabecera DDS inválida.');
    ...
    if(['DXT1','DXT3','DXT5'].contains(code)) {
      ...
      for(var y=0;y<h;y+=4){for(var x=0;x<w;x+=4){
        ...
        final c0=d.getUint16(offset,Endian.little),c1=d.getUint16(offset+2,Endian.little),colors=[rgb(d.getUint16(offset,Endian.little)),rgb(d.getUint16(offset+2,Endian.little))];
