...
String? nativeWeaponSoundPrefix(int family, String event) {
  ...
  const stems = {
    1: 'swordone', 2: 'swordtwo', 3: 'axeone', 4: 'axetwo',
    5: 'twin', 6: 'spear', 7: 'weaponone', 8: 'weapontwo',
    9: 'daggerbk', 10: 'dagger', 11: 'javelin', 12: 'staff',
    13: 'bow', 14: 'crobow', 15: 'knuckle',
  };
...
String? nativeMonSoundSlot(String event, {int attackIndex = 0}) => switch (event) {
